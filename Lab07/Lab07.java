...
public class Lab07
{
	...
	public static void loadData(MovieDB movies) throws IOException
	{
		...
		for(int i = 0; i < line; i ++)
		{
			...
			gross = S.nextDouble();
			S.nextLine();
			movies.addMovie(new Movie(title, director, studio, gross));
		}
	...
	public static void getCommands(MovieDB movies)
	{
		...
		while (true)
		{
			...
			else if (choice.equals("2"))
			{
				...
				double agross = S.nextDouble();
				S.nextLine();
				movies.addMovie(new Movie(aTitle, adirector, astudio, agross));
			}
			...
			else if (choice.equals("3"))
			{
				...
				System.out.println("Which movie do you want to find?");
				String find = S.nextLine();
				System.out.println(movies.findMovie(find));
			}
